...
4. If you are making Custom Armor, be aware that different resolutions cannot be combined
   ...
   4. Armor is very strict on formatting, and you are adviced to make sure you follow the guidelines in the [Armor](/creating-content/armors) section.
...
You can read more about them in the [NoteBlock Mechanics](/creating-content/blocks/noteblock) and its other pages.
...
The sub-mechanics can be found in the [StringBlock Mechanics](/creating-content/blocks/stringblock) and its other pages.
...
You can find the rest of the [Display-Entity Properties](/creating-content/furniture/display-entities).
