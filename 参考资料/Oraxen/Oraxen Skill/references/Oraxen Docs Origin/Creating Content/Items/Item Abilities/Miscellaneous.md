...
On 1.20.5+ use the new [Food-Component](/creating-content/items/components) instead
...
On 1.21+ use the new [JukeboxPlayable-Component](/creating-content/items/components) instead
...
On 1.20.5+ use the new [Durability-Component](/creating-content/items/components) instead
...
On 1.20.5+ use the new [FireResistant-Component](/creating-content/items/components) instead of burns_in_X below
On 1.21.2+ use the new [DamageResistant-Component](/creating-content/items/components) instead of burns_in_X/breaks_from_cactus below
...
These mechanic allows you to use an item as block. Since these are quite special mechanics, they have a [dedicated tutorial page](/creating-content/blocks/noteblock).

### clickAction

This mechanic allows you to run various events when a player clicks a block or furniture. It is very customizable, so it also has a [dedicated tutorial page](/creating-content/items/abilities/clickaction).
...
With this mechanic, you can change the item type detected by OraxenBlocks. Make sure to use a type declared [inside the block mechanic](/creating-content/blocks/noteblock#global-configuration).&#x20;
...
Mechanics:
  toggle_light:
    light: 5          # Base light level (0-15), always active
    toggle_light: 15  # Toggle light level (0-15), activated on interaction
```
...
This mechanic allows you to customize events, conditions and actions. Since it is a quite special mechanic, it has its [dedicated tutorial page](/creating-content/items/abilities/custom-ability).
