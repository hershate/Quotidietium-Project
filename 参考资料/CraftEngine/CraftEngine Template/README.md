...
└── 完整产业链/             ← 71 个端到端应用模板（覆盖采矿、农业、装饰、装备、钓鱼、红石、武器、存储、粒子、经济、音效、世界树、盔甲、战利品、模板、农耕、附魔、工具、酿造、活动、画作、工作台、BOSS、诅咒、探索、烹饪、容器、实体交互、复合方块、升阶、战利品、家具、植被、MythicMobs、字体、更新、分类、氧化、物理、水晶、液体、模型、建筑、座椅、悬挂、堆肥、木材、流体、文本、语言、数字格式、抽奖、任务、宠物、传送、强化、重铸、品质、宝箱、签到、灵魂绑定、赌博、幻化、拍卖、组队、特殊方块、附魔书、分解、套装、数据组件、药箭共71个游戏机制场景）
```
